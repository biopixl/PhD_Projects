...
The Eaton Fire ignited on January 7, 2025, in Eaton Canyon during an extreme Santa Ana wind event characterized by sustained winds of 40--60 mph with gusts exceeding 90 mph recorded at the ignition site \CITE. The fire exhibited explosive initial growth, expanding to over 10,600 acres within the first 24 hours before any containment could be established. Key fire characteristics include:

\begin{itemize}
    \item \textbf{Duration}: January 7--31, 2025 (24 days to full containment)
    \item \textbf{Area burned}: Approximately 14,000 acres (5,670 ha)
    \item \textbf{Structures destroyed}: >9,000 (second most destructive fire in California history)
    \item \textbf{Fatalities}: 19 confirmed (fifth deadliest in California history)
    \item \textbf{Burn severity}: Predominantly moderate to high in WUI areas
\end{itemize}

The fire burned through established residential neighborhoods containing homes ranging from 1890s Victorian-era construction to modern development, representing a diversity of building materials and potential contaminant sources. The housing stock includes single-family residences, multi-family units, and commercial structures, with construction materials spanning multiple eras of building codes and lead paint regulations.

The catastrophic pace of the fire---driven by the extreme wind conditions and dry vegetation following consecutive dry years---prevented effective evacuation in some areas and resulted in complete combustion of many structures. This high-severity burn pattern likely contributed to the mobilization and concentration of metals in the resulting ash deposits, as complete structural collapse concentrated building materials in localized debris piles.
