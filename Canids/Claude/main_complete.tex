...
Together, these evolutionary, developmental, and comparative genomic considerations motivate a phylogenetically explicit test of recent, breed-associated selection. To isolate genomic signals unique to the modern dog lineage, we employ a three-species design that contrasts domestic dogs with wolves while using dingoes as an evolutionary control for ancient domestication \sitep{Cairns2022, Souilmi2024\}. By applying adaptive Branch-Site Random Effects Likelihood (aBSREL), a method well suited for detecting episodic and branch-specific positive selection \textbackslash{}citep\{Smith2015, Luo2020, Wang2024\}, we restrict inference to the dog branch and specifically target selective pressures arising during modern breed formation rather than during the initial wolf-to-dog transition \textbackslash{}citep\{Pendleton2018\}. Within this framework, we address five integrated objectives: identifying dog-specific positively selected genes at a genome-wide scale; characterizing the biological pathways these genes comprise; testing whether Wnt signaling and neural crest developmental genes are enriched \textbackslash{}citep\{Wilkins2014\}; prioritizing candidate genes for experimental validation; and establishing a transparent, reproducible workflow following best-practice documentation standards \textbackslash{}citep\{Ostrander2024, Meadows2023\}. We hypothesize that modern dogs exhibit a substantial set of lineage-specific positively selected genes, including enrichment for neurodevelopmental, behavioral, and neural-crest-associated functions (e.g., \textit{EDNRB}), consistent with the neural crest hypothesis \textbackslash{}citep\{Wilkins2020, SanchezVillagra2021\}. By integrating branch-specific selection testing with developmental hypotheses and systematic gene prioritization, this study provides a scalable strategy for disentangling ancient domestication from recent artificial selection and contributes genomic evidence to ongoing debates on the origins and mechanisms of domestication syndrome.
...
Six genes met Tier 1 criteria (≥16 points). Three (\textit{GABRA3, HTR2B, HCRTR1}) encode neuromodulatory receptors previously implicated in behavioral differences in domestication models \textbackslash{}citep\{Belyaev1979, Trut2009\}. Two (\textit{FZD3, FZD4}) belong to the Wnt signaling pathway central to neural crest development \textbackslash{}citep\{Wilkins2014\}. Recovery of \textit{EDNRB}—a well-established domestication gene \textbackslash{}citep\{Karlsson2007\}—supports the validity of the phylogenetic framework.
