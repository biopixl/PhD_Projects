...
plot_a_labeled <- plot_a +
  draw_plot_label("A", x = 0, y = 1, size = 20, fontface = "bold")
plot_b_labeled <- plot_b +
  draw_plot_label("B", x = 0, y = 1, size = 20, fontface = "bold")
plot_c_labeled <- plot_c +
  draw_plot_label("C", x = 0, y = 1, size = 20, fontface = "bold")
plot_d_labeled <- plot_d +
  draw_plot_label("D", x = 0, y = 1, size = 20, fontface = "bold")
