...
# Add panel labels with better positioning (offset from corner)
plot_a_labeled <- plot_a +
  draw_plot_label("A", x = 0.02, y = 0.98, size = 20, fontface = "bold", hjust = 0, vjust = 1)
plot_b_labeled <- plot_b +
  draw_plot_label("B", x = 0.02, y = 0.98, size = 20, fontface = "bold", hjust = 0, vjust = 1)
plot_c_labeled <- plot_c +
  draw_plot_label("C", x = 0.02, y = 0.98, size = 20, fontface = "bold", hjust = 0, vjust = 1)
plot_d_labeled <- plot_d +
  draw_plot_label("D", x = 0.02, y = 0.98, size = 20, fontface = "bold", hjust = 0, vjust = 1)

# Arrange panels in 2x2 grid with optimal spacing
combined_figure <- plot_grid(
  plot_a_labeled, plot_b_labeled,
  plot_c_labeled, plot_d_labeled,
  ncol = 2,
  nrow = 2,
  align = "hv",
  axis = "tblr",
